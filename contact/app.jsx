  ...
  return (
    <header className="sol-header">
      <div className="container sol-header-inner">
        <a className="sol-logo" href="Homepage.html" aria-label="Eagle MSP home">
    ...
    <div className="form-card reveal">
      ...
      <form className="form-grid" onSubmit={(e) => { e.preventDefault(); setSent(true); window.scrollTo({ top: 0, behavior: 'smooth' }); }}>
        ...
        <label className="check-field">
          ...
          <span className="check-label">Yes, I'd like to receive cybersecurity tips, news, and updates from Eagle MSP. You can unsubscribe at any time.</span>
        </label>
