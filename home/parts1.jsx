    ...
    <header className={`header${scrolled ? ' scrolled' : ''}`}>
      <div className="container header-inner">
        <a href="#" className="logo-link" onClick={(e) => { e.preventDefault(); setActive('Home'); }}>
          <img src={(window.__resources && window.__resources.eagleLogo) || "assets/eagle-logo.png"} alt="Eagle MSP" />
        </a>
        <nav>
          <ul>
            {NAV.map((it) => (
    ...
    return (
      <section className="hero hero-centered" data-screen-label="Hero">
        ...
        <div className="container hero-c-inner">
          ...
          <p className="hero-mindset">Security is a mindset, not a service.</p>
