          ...
          <div className="local-map reveal">
            <div className="office-maps">
              <figure className="office-map">
                <iframe
                  title="Eagle MSP Bedford, NH office on Google Maps"
              ...
              <figure className="office-map">
                <iframe
                  title="Eagle MSP Scarborough, ME office on Google Maps"
  ...
  return (
    <footer className="footer">
      <div className="container footer-grid">
        <div>
          <img src={(window.__resources && window.__resources.eagleLogo) || "assets/eagle-logo.png"} className="footer-logo" alt="Eagle MSP" />
      ...
      <div className="footer-base">
        <span>© 2026 Eagle MSP · Eagle Network Solutions LLC · All Rights Reserved</span>
