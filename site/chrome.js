  ...
  var header =
    '<header class="sol-header">' +
      '<div class="container sol-header-inner">' +
        '<a class="sol-logo" href="Homepage.html" aria-label="Eagle MSP home">' +
          '<img src="assets/eagle-logo.png" alt="Eagle MSP">' +
        '</a>' +
    ...
    '<footer class="site-footer">' +
      '<div class="container site-footer-grid">' +
        '<div class="sf-brand">' +
          ...
          '<div class="sf-social">' +
            '<a href="https://www.facebook.com/eaglenetsolutions" target="_blank" rel="noopener" aria-label="Eagle MSP on Facebook">' + svg("facebook") + '</a>' +
            '<a href="https://www.linkedin.com/company/eagle-network-solutions" target="_blank" rel="noopener" aria-label="Eagle MSP on LinkedIn">' + svg("linkedin") + '</a>' +
            '<a href="https://www.instagram.com/eaglenetsolutions" target="_blank" rel="noopener" aria-label="Eagle MSP on Instagram">' + svg("instagram") + '</a>' +
          '</div>' +
        '</div>' +
        '<div class="sf-col">' +
          '<h4>Solutions</h4>' +
      ...
      '<div class="container site-subfooter">' +
        '<p>\u00A9 ' + new Date().getFullYear() + ' Eagle MSP. Eagle Network Solutions LLC. Family-owned and operated. BBB A+ rated since 2018.</p>' +
        '<div class="sf-legal">' +
